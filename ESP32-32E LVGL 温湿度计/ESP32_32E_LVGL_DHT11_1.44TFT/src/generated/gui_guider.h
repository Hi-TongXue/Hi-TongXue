...
LV_IMAGE_DECLARE(_bizhi1_RGB565A8_128x128);

LV_FONT_DECLARE(lv_font_HarmonyOS_Sans_SC_Regular_17)
LV_FONT_DECLARE(lv_font_HarmonyOS_Sans_SC_Regular_12)
LV_FONT_DECLARE(lv_font_HarmonyOS_Sans_SC_Regular_16)
LV_FONT_DECLARE(lv_font_DSEG7Classic_Regular_21)
LV_FONT_DECLARE(lv_font_HarmonyOS_Sans_SC_Regular_9)
LV_FONT_DECLARE(lv_font_DSEG7Classic_Regular_12)
LV_FONT_DECLARE(lv_font_Acme_Regular_22)
LV_FONT_DECLARE(lv_font_HarmonyOS_Sans_SC_Regular_10)
LV_FONT_DECLARE(lv_font_HarmonyOS_Sans_SC_Regular_8)
LV_FONT_DECLARE(lv_font_DSEG7Classic_Regular_13)
LV_FONT_DECLARE(lv_font_DSEG7Classic_Regular_11)
LV_FONT_DECLARE(lv_font_HarmonyOS_Sans_SC_Regular_11)
