...
void setup_scr_screen_2(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_2_label_1, 11, 45);
    lv_obj_set_size(ui->screen_2_label_1, 107, 39);
    lv_label_set_text(ui->screen_2_label_1, "EspTouch App\n配网");
    ...
    lv_obj_set_style_radius(ui->screen_2_label_1, 7, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_2_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_2_label_1, &lv_font_HarmonyOS_Sans_SC_Regular_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_2_label_1, 28, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->screen_2_label_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_shadow_width(ui->screen_2_label_1, 23, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(ui->screen_2_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui->screen_2_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui->screen_2_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_offset_x(ui->screen_2_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_offset_y(ui->screen_2_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
